...
// The archetype classifier is shared with the rest of the engine so the
// marketing kit and the diagnostic always agree on what KIND of business this
// is. See lib/business-archetype.js.
var { classifyBusinessArchetype } = require('./business-archetype');
...
// Delegates to the shared classifier so the marketing kit and the diagnostic
// always agree on the business type. Kept as a named export for backward
// compatibility with existing callers and tests.
function classifyMarketingArchetype(facts) {
  return classifyBusinessArchetype(facts);
}
