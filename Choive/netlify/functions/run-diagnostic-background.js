...
var PLATFORM_BLACKLIST_RE = /^(g2|g2\.com|trustpilot|capterra|clutch|yelp|tripadvisor|google|google maps|bing|amazon|ebay|etsy|facebook|meta|instagram|linkedin|x|twitter|youtube|tiktok|reddit|quora|wikipedia|hugging\s?face|github|gitlab|product\s?hunt|app\s?store|play\s?store|shopify app store|chatgpt|openai|claude|anthropic|gemini|perplexity|canal\+?|canal plus|m7|sky|sky germany|sky deutschland|astra|eutelsat|ses|dazn|discovery|rtl|pro7|prosieben|sat\.?1|ard|zdf|trt|bbc|itv|channel 4|hbo|netflix|disney\+?|amazon prime|apple tv\+?|peacock|paramount\+?)$/i;
                ...
                if (allSimResponsesOrig.length > 0) {
                  try {
                    ...
                    var extractPrompt =
                      ...
                      + '3. CRITICAL — SAME CATEGORY ONLY: Only return competitors that are SELLERS of the same type of product/service to the same buyer. If the subject sells B2B software/middleware, only return OTHER SOFTWARE VENDORS that sell to the same buyers. NEVER return: (a) companies that BUY the product (pay-TV operators, broadcasters, carmakers buying middleware are CUSTOMERS not competitors), (b) distribution/content platforms (CANAL+, Sky, satellite operators sell content/distribution NOT software), (c) infrastructure providers. The test: could a buyer choose the extracted company INSTEAD of the subject to get the same product? If not, it is not a competitor.\n'                      + '4b. OPERATOR VS SOFTWARE VENDOR: In media tech, AI responses often name OPERATORS (CANAL+, Sky, Eutelsat) when asked about platforms. These are distribution businesses that BUY or USE platform software. They are never competitors to a software vendor. If the AI response names an operator prominently, it means the operator is a potential CUSTOMER, not a rival.\n'
